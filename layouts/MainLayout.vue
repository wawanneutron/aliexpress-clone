<template>
  <div id="MainLayout" class="w-full fixed z-50">
    <div id="TopMenu" class="w-full bg-[#fafafd] border-b md:block hidden">
      <ul
      ...
      >
        ...
        <li class="px-3 hover:text-[#ff4646] cursor-pointer">
          <Icon name="ic:sharp-install-mobile" size="17">App</Icon>
          Buyer Protection
        </li>
        <li
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      <div
        class="flex lg:justify-start justify-between gap-10 max-1-[1150px] w-full px-3 py-5 mx-auto"
      >
            ...
            >
              <div class="p-1">
                ...
                >
                  ...
                  <div class="truncate ml-2">$ 98.99</div>
                </NuxtLink>
              </div>
            </div>
          </div>
