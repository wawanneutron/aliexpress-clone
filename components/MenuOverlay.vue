    ...
    <div class="flex items-center justify-between pt-5">
      <ul class="w-full">
        ...
        >
          ...
          <div
            class="flex items-center justify-center bg-[#ff4646] h-[35px] min-w-[35px] text-lg text-white rounded-lg text-white rounded-full"
          >
...
// const client = useSupabaseClinet()
